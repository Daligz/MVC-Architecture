...
public class MDB {
	...
	public MDB() {
        ...
        conexion = new Conexion("com.mysql.jdbc.Driver",  "jdbc:mysql://localhost:3306/upp_arquitectura?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&useTimezone=true&serverTimezone=GMT&useSSL=false", "root", "");//ESTA CADENA LARGA SE USA PARA MAC Y PARA ALGUNAS INSTALACIONES RECIENTES DE MYSQL
